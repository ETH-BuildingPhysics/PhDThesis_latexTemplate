...
The reference LES and coarse LES solve the standard filtered Navier-stokes equation for mass and momentum (\cite{Smagorinsky1963}), which can be written in conservative form as:
