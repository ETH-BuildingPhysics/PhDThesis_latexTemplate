...
Direct Numerical Simulation \index{Direct Numerical Simulation} (DNS) resolves all the turbulent scales. As it is an important topic, I add DNS to the index. Large Eddy Simulation \index{Large Eddy Simulation} (LES) is also in the index. How to build the index:
\begin{enumerate}
